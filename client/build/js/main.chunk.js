...
const Search = () => {
  ...
  const handleClick = e => {
    e.preventDefault();
    axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(`/api/tweets?search=${input}`).then(res => setUserTweets(res.data)).catch(err => console.log(err)); // input.match(' ') ? alert("Please write an appropriate user handle") : null
